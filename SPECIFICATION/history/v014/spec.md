...
flowchart LR
  ...
  WorkItemLifecycle -->|"valve + policy outcome events"| Attention
...
are truly unresolvable by the LLM remain human Attention items.
...
decisions MUST continue to appear as Attention items, each carrying its
